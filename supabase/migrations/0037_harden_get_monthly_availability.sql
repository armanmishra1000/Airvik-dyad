-- Make get_monthly_availability resilient when property_closures is missing
begin;
...
comment on function public.get_monthly_availability(date, uuid[])
  is 'Aggregates per-room-type availability, respecting seasonal and property closures when available.';
