-- Redefine bookings_summary_view to filter out reservations removed during edit
-- This ensures the Reservations list shows accurate room and guest counts after editing.
