        ...
        >
          {galleryImages.map((image, index) => (
            <motion.div
              ...
              className="bg-white p-1.5 shadow-lg [clip-path:polygon(8%_0,_100%_0,_100%_92%,_92%_100%,_0_100%,_0_8%)]"
            >
              <div className="relative h-52 w-full overflow-hidden group [clip-path:polygon(8%_0,_100%_0,_100%_92%,_92%_100%,_0_100%,_0_8%)]">
                <Image
                  src={image.src}
                  alt={image.alt}
                  fill
